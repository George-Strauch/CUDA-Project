...
Example run:
$ g++ bubble_omp.cpp -std=c++17 -O2 -g -fopenmp -o bubble
$ time ./bubble 10
$ time ./bubble 20000

$ perf record -e instructions,cache-misses,cache-references,context-switches,task-clock -F 2000 --call-graph dwarf ./bubble 20000
$ hotspot perf.data
*/
